...
#ifndef __lane_detection__CONTROLCONFIG_H__
#define __lane_detection__CONTROLCONFIG_H__
  ...
  public:
    ...
    void setParams(controlConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if("min_speed"==(*_i)->name){min_speed = boost::any_cast<double>(val);}
      }
    }
...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.base_speed = 2.5;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.base_speed = 1.0;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(controlConfig::AbstractParamDescriptionConstPtr(new controlConfig::ParamDescription<double>("base_speed", "double", 0, "Base Control Speed", "", &controlConfig::base_speed)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(controlConfig::AbstractParamDescriptionConstPtr(new controlConfig::ParamDescription<double>("base_speed", "double", 0, "Base Control Speed", "", &controlConfig::base_speed)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.speed_gain = 0.0;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.speed_gain = 0.3;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.speed_gain = 0.0;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(controlConfig::AbstractParamDescriptionConstPtr(new controlConfig::ParamDescription<double>("speed_gain", "double", 0, "Gain for Speed Down when Steering", "", &controlConfig::speed_gain)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(controlConfig::AbstractParamDescriptionConstPtr(new controlConfig::ParamDescription<double>("speed_gain", "double", 0, "Gain for Speed Down when Steering", "", &controlConfig::speed_gain)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.min_speed = 0.5;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.min_speed = 2.5;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.min_speed = 0.0;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(controlConfig::AbstractParamDescriptionConstPtr(new controlConfig::ParamDescription<double>("min_speed", "double", 0, "Minimum Speed for control", "", &controlConfig::min_speed)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(controlConfig::AbstractParamDescriptionConstPtr(new controlConfig::ParamDescription<double>("min_speed", "double", 0, "Minimum Speed for control", "", &controlConfig::min_speed)));
